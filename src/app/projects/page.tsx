          ...
          {projects.map((p, i) => (
            <div
              ...
              className={`flex flex-col md:flex-row items-center justify-between gap-6 
                bg-white dark:bg-[#243045] rounded-2xl shadow-md border border-blue-100 p-6 
                hover:shadow-blue-200/60 hover:-translate-y-1 transition-all duration-500`}
            >
              ...
              <div className="flex justify-center w-10 text-blue-400 animate-float">
                <svg
              ...
              <div className="flex justify-center md:justify-end w-full md:w-1/3">
                <div className="animate-float-image hover:scale-110 transition-transform duration-500">
                  <Image
                    src={p.img}
                    alt={p.alt}
                    width={110}
